...
public partial class CoffeeShopDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Contact__3214EC07BA047782");
...
//.HasConstraintName("FK__Contact__AdminID__5165187F");
           ...
           // entity.HasOne(d => d.Customer).WithMany(p => p.ContactCustomers)
            ...
            entity.HasOne(d => d.Problem).WithMany(p => p.Contacts)
                ...
                .HasConstraintName("FK__Contact__Problem__4D94879B");
        });
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__ProblemT__3214EC073A291209");
